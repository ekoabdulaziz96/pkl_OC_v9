        ...
        <div class="col-lg-12 ">
              <div class="col-lg-4 col-xs-6">
                  <div class="small-box bg-default" style="background-color: #E7F73A">
                    <div class="inner">
                      <h3>{{ $ft_admin_manajer }}</h3>
                      <p>Laporan FT Admin</p>
                    </div>
                    <div class="icon">
                      <i class="fa fa-user-o"></i>
                    </div>
                      <a href="{{ route('manajer.laporan-acc',[Auth::user()->id,'ft_admin']) }}" class="small-box-footer">Lihat Detail <i class="fa fa-arrow-circle-right"></i></a>
                  </div>
                </div>                  
                ...
                <div class="col-lg-4 col-xs-6">
                  <div class="small-box bg-default" style="background-color: #EFE32C">
                    <div class="inner">
                       <h3>{{ $ft_sponsorship_manajer }}</h3>
                       <p>Laporan FT Sponsorsip</p>
                    </div>
                    <div class="icon">
                      <i class="fa fa-user-o"></i>
                    </div>
                      <a href="{{ route('manajer.laporan-acc',[Auth::user()->id,'ft_sponsorship']) }}" class="small-box-footer">Lihat Detail <i class="fa fa-arrow-circle-right"></i></a>
                  </div>
                </div>                  
                ...
                <div class="col-lg-4 col-xs-6">
                  <div class="small-box bg-default" style="background-color: #EFE32C">
                    <div class="inner">
                       <h3>{{ $ft_kacab_manajer }}</h3>
                       <p>Laporan FT Kepala Cabanang</p>
                    </div>
                    <div class="icon">
                      <i class="fa fa-user-circle"></i>
                    </div>
                      <a href="{{ route('manajer.laporan-acc',[Auth::user()->id,'ft_kacab']) }}" class="small-box-footer">Lihat Detail <i class="fa fa-arrow-circle-right"></i></a>
                  </div>
                </div>                    
        </div>
      </div>
      ...
      <div class="panel-body">
           <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right" style="background-color: #B3E6B9">
              ...
              <li class="pull-left header"><i class="fa fa-hourglass-half"></i>Cabang</li>
            </ul>
          </div>
...
<script type="text/javascript">
   var table = $('#form-table').DataTable({
                ...
                serverSide: true,
                responsive: true,
                ajax: "{{ route('api.manajer.laporan-acc',[$user->id,$status]) }}",
                columns: [
...
function apiLaporan(status){
 ...
 $(function () {
     ...
     $("#manajer_Laporan").attr("class","active");
       if ('{{ $laporan_status }}' == 'acc_laporan'){
         $("#manajer_acc_laporan").attr("class","active");
          if('{{ $status }}' == 'ft_admin') $("#manajer_acc_laporan_ft_admin").attr("class","active");
          else if('{{ $status }}' == 'ft_sponsorship') $("#manajer_acc_laporan_ft_sponsorship").attr("class","active");
          else if('{{ $status }}' == 'ft_kacab') $("#manajer_acc_laporan_ft_kacab").attr("class","active");
          else if('{{ $status }}' == 'manajer') $("#manajer_acc_laporan_manajer").attr("class","active");
      }
    });
