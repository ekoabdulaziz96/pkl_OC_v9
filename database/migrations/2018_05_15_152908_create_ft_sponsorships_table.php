...
class CreateFtSponsorshipsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ft_sponsorship', function (Blueprint $table) {
           $table->increments('id');
            ...
            $table->string('acc_ft_kacab',20)->nullable()->default('baru');
            $table->string('komentar_ft_kacab',999)->nullable()->default('-');
            $table->boolean('send_ft_kacab')->nullable()->default(false);
    ...
    {
        Schema::dropIfExists('ft_sponsorship');
    }
}
